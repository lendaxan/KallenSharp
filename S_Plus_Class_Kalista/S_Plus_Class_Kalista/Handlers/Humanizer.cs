...
namespace S_Plus_Class_Kalista.Handlers
{
    internal class Humanizer : Core
    {
        ...
        private static Menu _Menu()
        {
            ...
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.LevelDelay", "Level Delay").SetValue(new Slider(750, 250, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.EventDelay", "Event Delay").SetValue(new Slider(750, 250, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.SoulBoundDelay", "SoulBound Delay").SetValue(new Slider(650, 250, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.ItemDelay", "Item Delay").SetValue(new Slider(650, 450, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.TrinketDelay", "Trinket Delay").SetValue(new Slider(1000, 500, 2000)));

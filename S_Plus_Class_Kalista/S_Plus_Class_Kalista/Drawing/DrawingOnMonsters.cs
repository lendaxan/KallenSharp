...
namespace S_Plus_Class_Kalista.Drawing
{
    internal class DrawingOnMonsters : Core
    {
        ...
        private static Utility.HpBarDamageIndicator.DamageToUnitDelegate _damageToMonster;

        public static Utility.HpBarDamageIndicator.DamageToUnitDelegate DamageToMonster
        {
